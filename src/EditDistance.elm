...
{-| This edit-distance algorithm is taken from [emilianobovetti/edit-distance](https://package.elm-lang.org/packages/emilianobovetti/edit-distance/latest/)
and modified as per our needs. We thank them for the implementation.
...
patternLoop : a -> List a -> Int -> Int -> Int -> List Int -> List Int
...
initPatternLoop : a -> List a -> Int -> List Int -> List Int
...
textLoop : List a -> List a -> Int -> List Int -> List Int
